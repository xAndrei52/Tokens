...
class PointAPI extends PluginBase implements Listener{
	...
	private function registerCommands(){
		...
		$commands = [
			"tokens" => "\\onebone\\pointapi\\command\\MyPointCommand",
			"toptokens" => "\\onebone\\pointapi\\command\\TopPointCommand",
			"settokens" => "\\onebone\\pointapi\\command\\SetPointCommand",
			"seetokens" => "\\onebone\\pointapi\\command\\SeePointCommand",
			"givetokens" => "\\onebone\\pointapi\\command\\GivePointCommand",
			"taketokens" => "\\onebone\\pointapi\\command\\TakePointCommand",
			"payt" => "\\onebone\\pointapi\\command\\PayPCommand",
			"setlangt" => "\\onebone\\pointapi\\command\\SetLangPCommand",
			"mystatust" => "\\onebone\\pointapi\\command\\MyStatusPCommand"
		];
